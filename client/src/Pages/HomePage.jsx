      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium">Discover Authentic Kenyan Craftsmanship</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link
              to="/register"
              className="group bg-white text-primary-700 font-semibold rounded-xl px-8 py-4 hover:bg-gray-50 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl focus-visible"
              aria-label="Sign up as an artisan to start selling your products"
            >
              Join as Artisan
              <ArrowRight className="inline w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" aria-hidden="true" />
            </Link>
            <Link
              to="/explore"
              className="group bg-transparent border-2 border-white text-white font-semibold rounded-xl px-8 py-4 hover:bg-white hover:text-primary-700 transition-all duration-300 transform hover:scale-105 focus-visible"
              aria-label="Browse and explore artisan products"
            >
              Explore Marketplace
            </Link>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 text-primary-100">
            Join thousands of artisans and customers connecting through authentic craftsmanship
          </p>
